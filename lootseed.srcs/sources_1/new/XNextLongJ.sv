...
module XNextLongJ(
    ...
    always @(posedge clk) begin
        ...
        a_states[2] <= a_states[1];
        a_states[3] <= a_states[2];
        a_states[4] <= a_states[3];
        a_states[5] <= a_states[4];
        a_states[6] <= a_states[5];
        a_states[7] <= a_states[6];
        a_states[8] <= a_states[7];
        a_states[9] <= a_states[8];
        a_states[10] <= a_states[9];
