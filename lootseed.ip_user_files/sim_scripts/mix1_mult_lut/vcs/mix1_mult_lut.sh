...
#
# Script generated by Vivado on Tue Sep 22 14:29:36 PDT 2026
# SW Build 6299465 on Fri Nov 14 12:34:56 MST 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : mix1_mult_lut.sh
...
#
# Usage        : mix1_mult_lut.sh
#                mix1_mult_lut.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                mix1_mult_lut.sh [-rerun]
#                mix1_mult_lut.sh [-reset_run]
#                mix1_mult_lut.sh [-clean]
#                mix1_mult_lut.sh [-reset_log]
#                mix1_mult_lut.sh [-help]
#
...
#                script (type 'mix1_mult_lut.sh -help' for more information).
#
...
# script info
echo -e "mix1_mult_lut.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./mix1_mult_lut.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.mix1_mult_lut -o mix1_mult_lut_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./mix1_mult_lut_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key mix1_mult_lut_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc mix1_mult_lut_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./mix1_mult_lut.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: mix1_mult_lut.sh [-help]\n\
Usage: mix1_mult_lut.sh [-step]\n\
Usage: mix1_mult_lut.sh [-lib_map_path]\n\
Usage: mix1_mult_lut.sh [-rerun]\n\
Usage: mix1_mult_lut.sh [-reset_run]\n\
Usage: mix1_mult_lut.sh [-clean]\n\
Usage: mix1_mult_lut.sh [-reset_log]\n\
Usage: mix1_mult_lut.sh [-keep_index]\n\
Usage: mix1_mult_lut.sh [-noclean_files]\n\n\
