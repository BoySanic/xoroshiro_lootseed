...
#                script (type 'add_i64_i32_lut.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.add_i64_i32_lut -o add_i64_i32_lut_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./add_i64_i32_lut_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key add_i64_i32_lut_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc add_i64_i32_lut_simv.daidir vcs_lib c.obj)
