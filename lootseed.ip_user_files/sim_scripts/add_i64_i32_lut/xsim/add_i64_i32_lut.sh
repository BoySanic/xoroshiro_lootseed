...
#
# Script generated by Vivado on Tue Sep 22 15:09:55 PDT 2026
# SW Build 6299465 on Fri Nov 14 12:34:56 MST 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : add_i64_i32_lut.sh
...
#
# Usage        : add_i64_i32_lut.sh
#                add_i64_i32_lut.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                add_i64_i32_lut.sh [-rerun]
#                add_i64_i32_lut.sh [-reset_run]
#                add_i64_i32_lut.sh [-clean]
#                add_i64_i32_lut.sh [-reset_log]
#                add_i64_i32_lut.sh [-help]
#
...
# script info
echo -e "add_i64_i32_lut.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./add_i64_i32_lut.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L xbip_utils_v3_0_15 -L c_reg_fd_v12_0_11 -L xbip_dsp48_wrapper_v3_0_7 -L xbip_pipe_v3_0_11 -L c_addsub_v12_0_21 -L secureip -L xpm --snapshot add_i64_i32_lut xil_defaultlib.add_i64_i32_lut -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim add_i64_i32_lut -key {Behavioral:sim_1:Functional:add_i64_i32_lut} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb add_i64_i32_lut.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./add_i64_i32_lut.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: add_i64_i32_lut.sh [-help]\n\
Usage: add_i64_i32_lut.sh [-step]\n\
Usage: add_i64_i32_lut.sh [-lib_map_path]\n\
Usage: add_i64_i32_lut.sh [-rerun]\n\
Usage: add_i64_i32_lut.sh [-reset_run]\n\
Usage: add_i64_i32_lut.sh [-clean]\n\
Usage: add_i64_i32_lut.sh [-reset_log]\n\
Usage: add_i64_i32_lut.sh [-keep_index]\n\
Usage: add_i64_i32_lut.sh [-noclean_files]\n\n\
