...
#
# Script generated by Vivado on Tue Sep 22 15:14:33 PDT 2026
# SW Build 6299465 on Fri Nov 14 12:34:56 MST 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : goldenratio_add.sh
...
#
# Usage        : goldenratio_add.sh
#                goldenratio_add.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                goldenratio_add.sh [-rerun]
#                goldenratio_add.sh [-reset_run]
#                goldenratio_add.sh [-clean]
#                goldenratio_add.sh [-reset_log]
#                goldenratio_add.sh [-help]
#
...
# script info
echo -e "goldenratio_add.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./goldenratio_add.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L xbip_utils_v3_0_15 -L c_reg_fd_v12_0_11 -L xbip_dsp48_wrapper_v3_0_7 -L xbip_pipe_v3_0_11 -L c_addsub_v12_0_21 -L secureip -L xpm --snapshot goldenratio_add xil_defaultlib.goldenratio_add -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim goldenratio_add -key {Behavioral:sim_1:Functional:goldenratio_add} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb goldenratio_add.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./goldenratio_add.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: goldenratio_add.sh [-help]\n\
Usage: goldenratio_add.sh [-step]\n\
Usage: goldenratio_add.sh [-lib_map_path]\n\
Usage: goldenratio_add.sh [-rerun]\n\
Usage: goldenratio_add.sh [-reset_run]\n\
Usage: goldenratio_add.sh [-clean]\n\
Usage: goldenratio_add.sh [-reset_log]\n\
Usage: goldenratio_add.sh [-keep_index]\n\
Usage: goldenratio_add.sh [-noclean_files]\n\n\
