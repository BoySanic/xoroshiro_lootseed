...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.mix1_mult_bram
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.mix1_mult_bram -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/boysanic/git/xoroshiro_lootseed/lootseed.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log mix1_mult_bram_sc.so .tmp_log xcelium_lib waves.shm c.obj)
